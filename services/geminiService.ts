...
// 引入提示词配置管理
import { getPromptById } from '../promptConfig';
// 引入本地 Embedding 库
...
export const regenerateSingleMap = async (
    ...
    const promptIdMap: Record<string, string> = {
        ...
        'world': 'mindmap_world',
        'chapters': 'mindmap_chapters',
        'character': 'mindmap_character',
        'events': 'mindmap_events',
        'mission': 'mindmap_mission',
        'anchor': 'mindmap_anchor',
